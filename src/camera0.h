...
private:
    ...
    void render_object_menu(scene& sc, shared_ptr<hittable> object, int id) {
        ...
        try {
            ...
            if(confirmDeleteModal){
                ImGui::OpenPopup("Corfim the Delection");
            }
            if(addObjectModal){
            ...
            if (ImGui::BeginPopupModal("Corfim the Delection", NULL, ImGuiWindowFlags_AlwaysAutoResize)) {
        ...
        if (ImGui::BeginMainMenuBar()) {
            ...
            if (ImGui::BeginMenu("View")) {
                ...
                if (ImGui::BeginMenu("Render Quality")) {
                    static int current_preset = 1; // Default to Fast
    ...
    void RenderObjectButtons(scene& sc) {
        ...
        ImGui::TextWrapped("To update, delete or duplicate an object, put the cursor on the object and click on RIGHT mouse button");
